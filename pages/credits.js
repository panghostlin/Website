	...
	function	renderSectionIllustrations() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/fakePicture01.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/fakePicture02.svg'}
				...
				<CreditsItem
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/fakePicture13.svg'}
	...
	function	renderSectionIcons() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/feature_hide.svg'}
					href={'https://www.flaticon.com/free-icon/visibility_633887?term=eye&page=1&position=50'}
					name={'Hide'}
					by={'Pixel perfect'} />
				<CreditsItem
					staticHref={'/static/images/feature_anonymous.svg'}
	...
	function	renderSectionDesertIllustrations() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/deserts/fakePicture_desert01.svg'}
					...
					by={'Pikisuperstar'} />
				<CreditsItem
					staticHref={'/static/images/deserts/fakePicture_desert02.svg'}
				...
				<CreditsItem
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/deserts/fakePicture_desert05.svg'}
				...
				<CreditsItem
					...
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/deserts/fakePicture_desert09.svg'}
	...
	function	renderSectionJungleIllustrations() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/jungles/fakePicture_jungle01.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/jungles/fakePicture_jungle02.svg'}
					href={'https://www.vecteezy.com/vector-art/175332-old-house-in-the-bayou-free-vector'}
					name={'Old House In The Bayou'}
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/jungles/fakePicture_jungle03.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/jungles/fakePicture_jungle04.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/jungles/fakePicture_jungle05.svg'}
		...
		return (
			<CreditsSection>
				...
				<CreditsItem
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/cities/fakePicture_city03.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/cities/fakePicture_city04.svg'}
					...
					by={'Pikisuperstar'} />
				<CreditsItem
					staticHref={'/static/images/cities/fakePicture_city05.svg'}
					href={'https://www.freepik.com/free-vector/flat-futuristic-night-city-background_4441675.htm'}
					name={'Flat futuristic night city background'}
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/cities/fakePicture_city06.svg'}
	...
	function	renderSectionSummerIllustration() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer01.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer02.svg'}
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer03.svg'}
					...
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer04.svg'}
				...
				<CreditsItem
					...
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer08.svg'}
					href={'https://www.vecteezy.com/vector-art/247178-music-around-campfire'}
					name={'Music Around Campfire'}
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/summers/fakePicture_summer09.svg'}
	...
	function	renderSectionBeachSunsetIllustration() {
		return (
			<CreditsSection>
				...
				<CreditsItem
					staticHref={'/static/images/beachSunsets/fakePicture_beachSunset01.svg'}
				...
				<CreditsItem
					...
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/beachSunsets/fakePicture_beachSunset05.svg'}
					href={'https://www.vecteezy.com/vector-art/114502-chair-beach-free-vector'}
					name={'Chair Beach Free Vector'}
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/beachSunsets/fakePicture_beachSunset06.svg'}
					href={'https://www.vecteezy.com/vector-art/175270-beach-sunset-illustration'}
					name={'Beach Sunset Illustration'}
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/beachSunsets/fakePicture_beachSunset07.svg'}
		...
		return (
			<CreditsSection>
				...
				<CreditsItem
					...
					by={'Freepik'} />
				<CreditsItem
					staticHref={'/static/images/brittany/fakePicture_brittany08.svg'}
					href={'https://www.vecteezy.com/vector-art/265702-vector-sea-landscape-illustration'}
					name={'Vector Sea Landscape'}
					by={'Vecteezy'} />
				<CreditsItem
					staticHref={'/static/images/brittany/fakePicture_brittany09.svg'}
